...
function twentynineteen_widgets_init2() {

	register_sidebar(
		array(
			'name'          => __( 'about', 'twentynineteen' ),
			'id'            => 'sidebar-2',
			'description'   => __( 'Add widgets here to appear in your footer.', 'twentynineteen' ),
			'before_widget' => '<section id="%1$s" class="widget %2$s">',
			'after_widget'  => '</section>',
...
add_action( 'widgets_init', 'twentynineteen_widgets_init2' );

function twentynineteen_widgets_init3() {

	register_sidebar(
		array(
			'name'          => __( 'Product Categories', 'twentynineteen' ),
			'id'            => 'sidebar-3',
			'description'   => __( 'Add widgets here to appear in your footer.', 'twentynineteen' ),
			'before_widget' => '<section id="%1$s" class="widget %2$s">',
			'after_widget'  => '</section>',
...
add_action( 'widgets_init', 'twentynineteen_widgets_init3' );

function twentynineteen_widgets_init4() {

	register_sidebar(
		array(
			'name'          => __( 'Iframe', 'twentynineteen' ),
			'id'            => 'sidebar-4',
			'description'   => __( 'Add widgets here to appear in your footer.', 'twentynineteen' ),
			'before_widget' => '<section id="%1$s" class="widget %2$s">',
			'after_widget'  => '</section>',
...
add_action( 'widgets_init', 'twentynineteen_widgets_init4' );
function twentynineteen_widgets_init5() {

	register_sidebar(
		array(
			'name'          => __( 'social-icon', 'twentynineteen' ),
			'id'            => 'sidebar-5',
			'description'   => __( 'Add widgets here to appear in your footer.', 'twentynineteen' ),
			'before_widget' => '<section id="%1$s" class="widget %2$s">',
			'after_widget'  => '</section>',
...
add_action( 'widgets_init', 'twentynineteen_widgets_init5' );
